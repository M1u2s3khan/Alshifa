  // ============================================================
        ...
        const TRANSLATIONS = {
            ...
            'about.p3': { hi: 'इस केंद्र की शुरुआत भारत के प्रसिद्ध उनानी चिकित्सक <strong>‘डॉ. मोहम्मद दीन’</strong> ने की, जिन्होंने 15 वर्षों का समृद्ध अनुभव और टिबिया कॉलेज, करोल बाग और बाद में माजिदिया हॉस्पिटल, जामिया हमदर्द, नई दिल्ली में सफलतापूर्वक अभ्यास किया है।',
            ...
            'footer.l1': { hi: 'होम', en: 'Home' },
            'footer.l2': { hi: 'परिचय', en: 'About' },
            'footer.l3': { hi: 'सेवाएँ', en: 'Services' },
            'footer.l4': { hi: 'संपर्क करें', en: 'Contact Us' },
        ...
        const SERVICES_DATA = [{
            img: 'https://via.placeholder.com/70/0a5c36/fff?text=S',
        ...
        const GALLERY_ITEMS = [
            { id: 1, titleKey: 'gallery.item1', descKey: 'gallery.desc1', category: 'hijama', img: 'https://via.placeholder.com/400/0b3b2c/fff?text=Hijama' },
            { id: 2, titleKey: 'gallery.item2', descKey: 'gallery.desc2', category: 'hijama', img: 'https://via.placeholder.com/400/1f7b5a/fff?text=Hijama+2' },
            { id: 3, titleKey: 'gallery.item3', descKey: 'gallery.desc3', category: 'fasd', img: 'https://via.placeholder.com/400/2a4a3a/fff?text=Fasd' },
            { id: 4, titleKey: 'gallery.item4', descKey: 'gallery.desc4', category: 'fasd', img: 'https://via.placeholder.com/400/0b3b2c/fff?text=Fasd+2' },
            { id: 5, titleKey: 'gallery.item5', descKey: 'gallery.desc5', category: 'irsale', img: 'https://via.placeholder.com/400/1f7b5a/fff?text=Leech' },
            { id: 6, titleKey: 'gallery.item6', descKey: 'gallery.desc6', category: 'irsale', img: 'https://via.placeholder.com/400/2a4a3a/fff?text=Leech+2' },
            { id: 7, titleKey: 'gallery.item7', descKey: 'gallery.desc7', category: 'dalk', img: 'https://via.placeholder.com/400/0b3b2c/fff?text=Dalk' },
            { id: 8, titleKey: 'gallery.item8', descKey: 'gallery.desc8', category: 'dalk', img: 'https://via.placeholder.com/400/1f7b5a/fff?text=Dalk+2' },
            { id: 9, titleKey: 'gallery.item9', descKey: 'gallery.desc9', category: 'hammam', img: 'https://via.placeholder.com/400/2a4a3a/fff?text=Hammam' },
            { id: 10, titleKey: 'gallery.item10', descKey: 'gallery.desc10', category: 'hammam', img: 'https://via.placeholder.com/400/0b3b2c/fff?text=Hammam+2' },
            { id: 11, titleKey: 'gallery.item11', descKey: 'gallery.desc11', category: 'ayurveda', img: 'https://via.placeholder.com/400/1f7b5a/fff?text=Natool' },
            { id: 12, titleKey: 'gallery.item12', descKey: 'gallery.desc12', category: 'ayurveda', img: 'https://via.placeholder.com/400/2a4a3a/fff?text=Natool+2' },
            { id: 13, titleKey: 'gallery.item13', descKey: 'gallery.desc13', category: 'ayurveda', img: 'https://via.placeholder.com/400/0b3b2c/fff?text=Ayurveda' },
            { id: 14, titleKey: 'gallery.item14', descKey: 'gallery.desc14', category: 'ayurveda', img: 'https://via.placeholder.com/400/1f7b5a/fff?text=Ayurveda+2' },
            { id: 15, titleKey: 'gallery.item15', descKey: 'gallery.desc15', category: 'ayurveda', img: 'https://via.placeholder.com/400/2a4a3a/fff?text=Ayurveda+3' }
        ];
                    ...
                    <div class="col-md-6 col-lg-3" data-aos="flip-up" data-aos-duration="600" data-aos-delay="${idx * 80}">
                        <div class="card-unani p-3 shadow-lg rounded-3 border-0 h-auto">
                            <div class="d-flex align-items-center gap-3 mb-2">
                                <img style="width: 70px; height: 70px; object-fit: cover;" src="${s.img || 'https://via.placeholder.com/70'}" alt="${currentLang === 'hi' ? s.title_hi : s.title_en}" class="service-img rounded-circle" onerror="this.src='https://via.placeholder.com/70'">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    ...
                    showToast('Your inquiry has been logged to the console! (F12 → Console)');
                    form.reset();
